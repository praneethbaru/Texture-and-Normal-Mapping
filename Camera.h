...
public:
	...
	Camera(
		glm::vec3 position_ = glm::vec3(-0.6, 1.7, 5.0),
	...
	glm::mat4 get_projection_mat(float z_near, float z_far)
	{
		this->proj_mat = glm::perspective(this->zoom, (GLfloat)this->width / (GLfloat)this->height, z_near, z_far);
